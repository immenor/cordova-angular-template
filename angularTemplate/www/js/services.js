    ...
    factory('portfolioContentService', function($log) {
        return {
            interfaceExamples:  {
                ...
                skuloop: { name: 'say again', image: 'images/sayagain.jpg', large: null, larger: null, description: null},
                shopping: { name: 'solid bump', image: 'images/sbr.png', large: null, larger: null, description: null},
                po2: { name: 'skuloop', image: 'images/skuloop.png', large: null, larger: null, description: null}
            },
            identityExamples: {
